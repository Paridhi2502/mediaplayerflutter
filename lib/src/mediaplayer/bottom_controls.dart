...
import 'package:flutter_demo_media_player_app/src/mediaplayer/player_list.dart';
import 'package:flutter_demo_media_player_app/src/mediaplayer/songs.dart';
import 'package:flutter_demo_media_player_app/src/mediaplayer/theme.dart';
    ...
    context: context,
      builder: (builder) {
        return new Container(
          ...
          child: new Center(
            child: new PlayerList(
              playerList: demoPlaylist.songs,
            ),
          ),
        );
      });
